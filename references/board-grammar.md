...
The screen→board link keeps getting drawn as "a colored line, close enough" — and it gets rejected every time. Whether it ends up a cloned CONNECTOR or a VECTOR fallback, it must replicate the harvested exemplar on all five counts:
